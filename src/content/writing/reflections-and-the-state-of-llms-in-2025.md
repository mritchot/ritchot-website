...
There has been real progress in how AI tools view the world. In my piece just over a year ago, [*o1 still sucks at math*](/writing/o1-pro-mode-still-has-a-long-way-to-go-for-mathematics/), I told my students they still had to do the heavy lifting due to the weakness in the vision models that LLMs use. That has shifted considerably, and in my [follow-up piece,](/writing/gpt-5-has-come-a-long-way-in-mathematics/) my main point was that I no longer have any doubts about these models doing real-world tasks going forward[^1]. As AI sees the world through "alien" eyes, the role of the student (and the teacher) shifts to providing context, alignment, and verification.
